...
// Right_Wing           digital_out   E               
// Claw_Up              digital_out   H               
// Claw                 digital_out   G               
// Mogo                 digital_out   A               
// Arm                  motor         20              
// Arm_Rotation         rotation      7               
...
void pre_auton(void) {
  ...
  while(auto_started == false){            //Changing the names below will only change their names on the
    ...
    switch(current_auton_selection){       //Tap the brain screen to cycle through autons.
      case 0:
        Brain.Screen.printAt(50, 50, "Full Solo AWP");
        break;
      case 1:
        Brain.Screen.printAt(50, 50, "Red Left 4 Ring");
        break;
      case 2:
        Brain.Screen.printAt(50, 50, "Red Right/ Solo AWP");
        break;
      case 3:
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    //Claw setup
    Arm_Rotation.setPosition(0, degrees);
    Arm.setBrake(hold);
